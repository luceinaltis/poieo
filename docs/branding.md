...
획을 연결한다. 이름은 다섯 글자가 분명하게 읽혀야 하며, 금색은 열매 한 곳에 둔다.

### 로고 A · 단정한 필선

굵기를 정돈한 나무 실루엣과 짧게 벌어지는 세리프를 조합한다.
묵직하고 또렷한 인상을 주는 방향이다.

![로고 A: 정돈한 나무 실루엣과 단정한 poieo 워드마크](assets/branding/logo-refined-concept.png)

### 로고 B · 붓의 리듬

휘어진 줄기와 가늘어지는 획, 부드럽게 이어지는 글자 모양을 조합한다.
**선택한 담채 화면과 연결하기에는 B를 우선 제안한다.** 로고 선택은 아직 확정하지 않았다.

![로고 B: 붓의 리듬을 살린 나무와 poieo 워드마크](assets/branding/logo-brush-concept.png)

두 시트의 분리형·단색 표시는 조합을 살펴보기 위한 생성 시안이다.
