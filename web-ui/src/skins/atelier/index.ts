...
export function makeBench(
  ...
  return {
    ...
    tick(elapsed: number) {
      ...
      // after, so the hammer below is aimed at the arm as corrected rather
      // than as the clip left it. Both are skipped while he is swinging, when
      // there is no correction to see.
