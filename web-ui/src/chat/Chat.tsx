...
import { pendingChange } from "../state/stage"
...
const SETTLED: Record<string, string> = { applied: "taken", discarded: "thrown away", undone: "undone" }

/**
 * What an answer changed in the project, and -- while it waits in the chat's
